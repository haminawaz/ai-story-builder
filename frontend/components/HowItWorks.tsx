...
const steps = [
  {
    ...
    description: "Type it, speak it, or upload a draft, however you remember it best.",
  },
  {
    number: "02",
    title: "Answer a Few Heartfelt Questions",
    description: "Our AI gently asks you meaningful prompts to bring out the emotion and details.",
  },
  {
    number: "03",
    title: "Receive a Beautifully Shaped Story",
    description: "Get a ready-to-read version of your memory polished, personal, and precious.",
  },
];
        ...
        <div className="flex flex-col gap-8">
          {steps.map((step, index) => (
            <div key={index} className="flex flex-col gap-3">
              <p className="text-2xl font-[500]">{step.number} | {step.title}</p>
