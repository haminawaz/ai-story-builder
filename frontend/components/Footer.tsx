  ...
  return (
    <footer className="bg-[#457B9D] py-10 md:py-15 px-6 sm:px-8">
      <div className="max-w-5xl mx-auto text-center">
        {/* Logo */}
        <div className="mb-8">
          <h3 className="font-serif text-4xl text-white font-light tracking-widest">
            LOGO
          </h3>
        </div>
        ...
        <div className="mb-12 max-w-2xl mx-auto">
          <p className="text-white/90 leading-relaxed text-xl sm:text-2xl font-[Cormorant_Garamond] italic">
            Every memory is a piece of who you are. We&apos;re here to help you shape it into something that lasts forever.
          </p>
        </div>
